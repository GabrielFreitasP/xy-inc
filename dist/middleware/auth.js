...
exports.default = (function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var authHeader, parts, scheme, token, _a, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                _a = req;
                return [4 /*yield*/, AuthService_1.default.verifyToken(token)];
            case 1:
                _a.username = _b.sent();
                next();
                return [3 /*break*/, 3];
            case 2:
                err_1 = _b.sent();
                if (err_1) {
                    if (err_1.name === 'TokenExpiredError' && err_1.message === 'jwt expired') {
                        return [2 /*return*/, res.status(401).send({
                                success: false,
                                message: 'Token expired'
                            })];
                    }
                    if (err_1.name === 'JsonWebTokenError' && err_1.message === 'jwt malformed') {
                        return [2 /*return*/, res.status(401).send({
                                success: false,
                                message: 'Token malformed'
                            })];
