...
describe("Calculete Distance", () => {
  it('should be able to calculate the distance between two points', async () => {
  ...
  it('should be able to calculate the distance between two points with posite result', async () => {
